...
2. **Work Tenure**:  
   ...
   - Majority of employees have worked in **only one company**.
...
- **The ROC curve for the final model of Random Forest:**
...
2. **Learning Curve Analysis**:  
   ...
   - The gini impurity vs alpha values is plotted to choose the ideal alpha value
...
3. **KNN Elbow Method**:  
   ...
   - The accuracy decreases as K increases
   - <img src="image/knn.png" alt="KNN learning curve" width="500"/>
   - The accuracy in both training and test data decrease as the number of neighbors increases.
